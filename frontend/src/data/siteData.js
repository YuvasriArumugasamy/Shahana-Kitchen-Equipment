...
export const PRODUCTS = [
  ...
  },
  {
    ...
    category: "Wet Grinders",
    capacity: "5 Litres to 40 Litres",
    motor: "1.5 HP - 5 HP Heavy Duty Motor",
    material: "Full Stainless Steel 304 & Granite Stones",
    voltage: "230V / 415V",
    price: "₹38,000",
    rating: 4.9,
    reviewsCount: 35,
    ...
    description: "Commercial tilting wet grinder with heavy duty stainless steel drum and natural granite grinding stones for effortless batter tilting and pouring.",
    features: [
      "Effortless Tilting & Pouring Mechanism",
      "Food Grade 304 Stainless Steel Drum",
      "Heavy Duty Natural Granite Grinding Stones",
      "High Torque Lakshmi Copper Motor Drive"
    ],
    applications: ["Hotels", "Restaurants", "Batter Units", "Marriage Caterers"]
  },
  {
    ...
    motor: "1.5 HP Heavy Duty Lakshmi Motor",
